const StandaloneWebWidget = require("../lib/standalone-web-widget");
const HtmlWebpackPlugin = require("html-webpack-plugin");
const webpack = require("webpack");
const path = require("path");
const StandalonePlugin = require("../lib/standalone-web-widget");
const fs = require("fs").promises;

describe("standalone-web-widget-webpack-plugin", () => {
