...
module.exports = class WebWidgetSvelteGenerator extends PnpmGenerator {
  ...
  finished() {
    this.on(`${this.options.packageManager}Install:end`, () => {
      ...
      bwLog("Steps to test your Svelte web-widget application:");
      bwLog(`1. Run '${this.options.packageManager} start'`);
      bwLog(
        `2. Go to http://web-widget-playground.org/playground/instant-test?name=@${this.options.orgName}/${this.options.projectName}&url=5000 to see it working!`
      );
    });
  }
};
