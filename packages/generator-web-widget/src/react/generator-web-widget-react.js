...
module.exports = class WebWidgetReactGenerator extends PnpmGenerator {
  ...
  async createPackageJson() {
    ...
    if (this.options.typescript) {
      ...
      // Will be replaced by webpack-config-web-widget-react-ts
      delete packageJson.devDependencies[
        "@web-widget/webpack-config-web-widget"
      ];
      // Will be replaced by webpack-config-web-widget-react-ts
      delete packageJson.devDependencies[
        "@web-widget/webpack-config-web-widget-ts"
      ];
...
Steps to test your React web-widget application:
1. Run '${this.options.packageManager} start${
          this.options.packageManager === "yarn" ? "" : " --"
        } --port 8500'
2. Go to http://web-widget-playground.org/playground/instant-test?name=@${
